...
while play_again == "":
  ...
  if question_format == 1:
    q_a_input = input("- Round {} -\nWhat is the English word for {}?\nA: {}\nB: {}\nC: {}\nD: {}\n".format(round_number, easy_word, correct_word, easy_B, easy_C, easy_D)).lower()    
    ...
    if q_a_input == "a":
     ...
     play_again = input("Press <enter> to play again or type anything else to quit.\n").lower()
    else:
     score = score - 1
    ...
    q_b_input = input("- Round {} -\nWhat is the English word for {}?\nA: {}\nB: {}\nC: {}\nD: {}\n".format(round_number, easy_word, easy_A, correct_word, easy_C, easy_D)).lower()
    if q_b_input == "b":
     score = score + 1
     print("That is correct! You gained one point and your score is {}.\n".format(score))
    else:
    ...
    q_c_input = input("- Round {} -\nWhat is the English word for {}?\nA: {}\nB: {}\nC: {}\nD: {}\n".format(round_number, easy_word, easy_A, easy_B, correct_word, easy_D)).lower()
    if q_c_input == "c":
     score = score + 1
     print("That is correct! You gained one point and your score is {}.\n".format(score))
    else:
    ...
    q_d_input = input("- Round {} -\nWhat is the English word for {}?\nA: {}\nB: {}\nC: {}\nD: {}\n".format(round_number, easy_word, easy_A, easy_B, easy_C, correct_word)).lower()
    if q_d_input == "d":
     score = score + 1
     print("That is correct! You gained one point and your score is {}.\n".format(score))
    else:
